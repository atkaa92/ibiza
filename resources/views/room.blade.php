		...
		<div class="top-bg">
			<div class="container">
				...
				<ul class="breadcrumb">
					...
					<li class="breadcrumb__item">
						<a href="rooms.php">Սենյակներ</a>
					</li>
					<li class="breadcrumb__item">Շոգեբաղնիք Ռուսական</li>
				</ul>
			</div>
			<div class="top-info cf">
				<div class="container">
					<h1 class="top-info__title pull-left">Շոգեբաղնիք Ռուսական</h1>
					<p class="top-info__price pull-right"><b>20000 դրամ </b><small>Ժամը</small></p>
				</div>
			</div>
		</div>
		<section class="section section--int">
			<div class="container">
				<div class="grid">
							...
							<ul class="slider-inner__thumbs clearfix">
								@for($i = 0; $i < 3 ; $i++)
									<li class="slider-inner__thumbs-item thumb-active">
										<img alt="" src="/images/rooms/Cottage_1/cottage_{{$i}}.jpg">
									</li>
								@endfor
							</ul>
						</div>
					...
					<div class="grid__col-md-4 grid__col-sm-4 grid__col-xs-12">
						<div class="reservation">
							<h1 class="main-title main-title-cl">Ամրագրելու համար զանգահարել</h1>
				...
				<div class="bordered bordered--int">
					<h2 class='secondary-title'>Նկարագրություն</h2>
